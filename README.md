...
| 🏟️ **07. ベンチマーク選手権** (JCommonsenseQA / JMMLU / MGSM-ja / 対話 を実走し総合王者を決定) （解析基盤利用）| [![Open 07](https://mybinder.org/badge_logo.svg)](https://binder.cs.rcos.nii.ac.jp/v2/gh/jxta/LLM-jp_playground/main?urlpath=lab%2Ftree%2Fnotebooks%2F07_benchmark_olympiad.ipynb) | 
